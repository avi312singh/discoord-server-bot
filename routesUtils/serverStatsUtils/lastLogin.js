            ...
            try {
                if (encodedNameToBeStored) {
                    pool.getConnection((err, connection) => {
                        ...
                        connection.query(`INSERT INTO playerInfo (playerName, online) VALUES ('${name}', 0) ON DUPLICATE KEY UPDATE totalTime = totalTime + .25, totalTimeDaily = totalTimeDaily + .25, lastLogin = '${timestampForLastLogin}'`, (err, result) => {
                            connection.release();
