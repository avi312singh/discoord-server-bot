    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            pool.getConnection((err, connection) => {
                ...
                switch (duration) {
                    case 288:
                        connection.query(`SELECT playername, ceiling(totalKillsWeekly) as totalKillsWeekly, ceiling(totalTimeWeekly) as totalTimeWeekly, ROUND(totalKillsWeekly/totalTimeWeekly, 2) as killsPerTimeSpentRatio
                        FROM sys.playerInfo
